function comprobar2(){
    var nom = document.update.nombre.value;
    var ape = document.update.apellido.value;
    var dni = document.update.dni.value;
    ...
    var x = /[abcdefghijklmnñopqrstuvwxyz]+/; //solo permite estos caracteres (minimo 1)
    if(!x.test(nom)){
